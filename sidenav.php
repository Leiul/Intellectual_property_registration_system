...
<body>
    ...
    <div class="sidebar">
        <header> wellcome to sidama science and Information technology ICT Centre</header>
    </div>
    <div class="list">
        <ul>
            <li><a href="dashbord.php">Dashboard</a></li>
            <li><a href="sidenav.php">Register</a></li>
            <li><a href="view.php">Manage</a></li>
            <li><a href="#">FAQ</a></li>
    ...
    <div class="container">
      ...
      <div class="container ">
         <form  method="post" action=""style="width:50vw; min-width:300px;">
            <div class="row mb-3">
               <div class="col">
